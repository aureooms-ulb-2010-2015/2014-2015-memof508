...
\defbox{
	The comparability graph ${G}(P)$ is an undirected graph where all comparable elements in $P$ are represented as adjacent elements.
}

\defbox{
	The incomparability graph $\widetilde{G}(P)$ is an undirected graph where all incomparable elements in $P$ are represented as adjacent elements.
}
