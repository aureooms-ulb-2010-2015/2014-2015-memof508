...
What is drawn in a Hasse diagram is called the \concept{transitive reduction} of the relation graph and the relations contained in the drawing are called \concept{cover relations}. Furthermore, if $x < z$ is a cover relation then we say that $x$ is covered by $z$ or $z$ covers $x$, and we write $x \lessdot z$ or $z \gtrdot x$.
