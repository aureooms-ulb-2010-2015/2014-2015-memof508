...
This is really what we do when we sort a random sequence of elements efficiently with quicksort or any other \BigO{n \log n} algorithm. We exploit the transitive nature of partial orders.