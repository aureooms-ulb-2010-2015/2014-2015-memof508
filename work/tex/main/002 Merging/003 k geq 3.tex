...
\nb{Giving $\dots$ in the form of the Stirling's approximation gives us $(m') \log(m') - \sum_{i=1}^{k} m_i \log m_i$ which clearly express the information contained in the sorted sequence $s'$ of $m'$ elements minus the information we already have.}
