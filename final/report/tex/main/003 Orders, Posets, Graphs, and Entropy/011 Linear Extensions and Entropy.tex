...
problem called \supi (\SUPI). This problem can be solved using \BigO{ITLB}
...
\begin{theorem}[\citet*{kahn:1995} (1995)]
\label{eq:khankim1}
...
\(n H(\widetilde{\P}) = \BigTheta{e(\P)}\) and because we can compute
...
\begin{theorem}[\citet*{cardinal:2013} (2013)]
For any poset \(\P\) of order \(n\),
\begin{displaymath}
