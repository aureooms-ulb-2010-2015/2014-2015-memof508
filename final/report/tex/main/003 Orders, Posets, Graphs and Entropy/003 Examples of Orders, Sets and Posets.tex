...
\nb{For all examples, $[n] = \left\{{1, 2, \cdots, n}\right\}$, $\N$ is the set
of natural numbers and $P$ is the set of positive numbers (also called the set
of 1-based natural numbers).}
