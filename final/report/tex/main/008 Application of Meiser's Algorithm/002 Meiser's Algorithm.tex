...
For fixed $k$, \(\H\) is the set of hyperplanes having equation involving exactly $k$
...
\begin{figure}
\begin{center}
\includegraphics[trim=110 40 50 30,clip=true,height=0.35\textheight]{fig/point-location/simplex.eps}
\caption{
