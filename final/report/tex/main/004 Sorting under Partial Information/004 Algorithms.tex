...
\cite{kahnkim1} gave the the first polynomial-time algorithm achieving the
...
Finally, in 2013, \cite{cardinal2013sorting}, new methods are developed. Three
...
\cite{kahnkim1} on the number of comparisons performed by their algorithm is
$54.45 \cdot \log e(P)$. The improved bound given in the table is a byproduct
of the results of \cite{cardinal2013sorting}. (The notation $\BigOe{n}$ means
