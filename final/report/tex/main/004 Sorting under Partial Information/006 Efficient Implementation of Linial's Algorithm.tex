...
In this section we present original developments on Linial's work~\cite{linial:1984}.
We explain
...
\enum{b_1}\), then stop.
\end{algorithm}
The only steps where we query the oracle are step \step{3.2.2} and step
\step{3.3.1}.
