...
we obtain the posets represented by the Hasse diagrams (\Cref{tree:poset:hasse})
...
In \Cref{tree:related:xy} we saw \ref{fig:related:xy} which shows us all the order
...
in \Cref{tree:merging:kgeq3} to prove that it is indeed the case.
