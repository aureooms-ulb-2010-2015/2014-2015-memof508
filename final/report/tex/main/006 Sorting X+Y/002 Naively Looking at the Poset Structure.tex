...
A Young tableau is a special way of labelling the \(n\) tiles of a Ferrers
...
We now return to our original problem. A \( n \times n \) bounded lattice can be regarded as a \( n \times n \)
