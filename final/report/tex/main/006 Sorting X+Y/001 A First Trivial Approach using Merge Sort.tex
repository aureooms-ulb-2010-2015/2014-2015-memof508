...
information already in our possession. We can reuse this information optimally
using the Huffman code based merging algorithm we presented in
\ref{tree:merging:kgeq3}.
