...
We now analyze the \ITLB for the problem of merging two totally ordered sets of
...
logarithm of the number of possible solutions for this problem, \ie
...
An algorithm performing \BigO{\log n} queries is Binary Search.
