\section{Merging \(2\) Totally Ordered Sets}
...
An algorithm performing \BigO{m} is Sequential Merge (or Tapemerge).
...
Hence the only way the \concept{ITLB} can be \BigOmega{n} is if \(m =
